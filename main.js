...
nextOne.addEventListener('click', e => {
    ...
    /*alert(document.getElementById('letter-note-five').textContent);
    document.getElementById('letter-note-five').style.backgroundColor = 'black';*/
